...
export const DevToolsView: Component = () => {
  ...
  return (
    <div class="flex flex-col gap-5" aria-label={t().sidebar.navDevtools}>
      ...
      {/* Navigation Tabs */}
      <Tabs value={activeTab()} onValueChange={(d) => setActiveTab(d.value as any)} class="w-full">
        <TabsList class="mb-4">
          <TabsTrigger value="tools">
            <span>{t().devops.tabToolchains}</span>
            <span class="rounded-full bg-bg-subtle px-1.5 py-0.2 text-[10px] mono tabular-nums">
            ...
            <div class="glass-card flex flex-col md:flex-row md:items-center justify-between gap-3 p-4">
              <div>
                <div class="flex items-center gap-2">
                  ...
                  <Badge variant="success" class="mono font-bold">
                    {detectedKeys().length}
                  </Badge>
                </div>
              ...
              <div class="flex flex-wrap items-center gap-2.5">
                ...
                <div class="flex items-center gap-1 bg-bg-surface/80 p-1 rounded-lg border border-border-subtle">
                  <Button
                    type="button"
                    variant={selectedKeyCategory() === 'ALL' ? 'default' : 'ghost'}
                    size="sm"
                  ...
                  <Button
                    type="button"
                    variant={selectedKeyCategory() === 'ai' ? 'default' : 'ghost'}
                    size="sm"
                  ...
                  <Button
                    type="button"
                    variant={selectedKeyCategory() === 'cloud' ? 'default' : 'ghost'}
                    size="sm"
                  ...
                  <Button
                    type="button"
                    variant={selectedKeyCategory() === 'saas' ? 'default' : 'ghost'}
                    size="sm"
